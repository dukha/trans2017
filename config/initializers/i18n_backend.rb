...
#I18n.backend= I18n::Backend::KeyValue.new(Redis.new(db: 1,  password: '123456'))#Rails.application.secrets.redis_local_pw))
...
I18n.backend= I18n::Backend::Chain.new(
   I18n::Backend::KeyValue.new(Redis.new(db: 2, password: '123456')),#Rails.application.secrets.redis_local_pw)),
   I18n.backend
   ) 
#=end
