class TranslationHint < ActiveRecord::Base
  ...
  TranslationHint.create!(:dot_key_code => "number.currency.format.significant",:heading => "Currency Format", :example => "", :description => "False mean everything is rounded down by default. '! 'false'' means that currency is rounded as you expect") # false
  TranslationHint.create!(:dot_key_code => "number.currency.format.strip_insignificant_zeros",:heading => "Currency Format", :example => "", :description => "'False' means that you remove and zeros that don't mean anything") # false
