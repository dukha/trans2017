...
=end
 ...
 def self.demo
   ...
   TranslationLanguage.create!(:iso_code=> "zh-TW", :name=>"Chinese(Taiwan)", :plural_sort => "other")
   TranslationLanguage.create!(:iso_code=> "zh-CN", :name=>"Chinese(China)", :plural_sort => "other")
